...
var getPost = function(i) {
  ...
  var ex3 =_.compose(getComments, _.map(_.prop('id')) ,getPost);
//   以下未原答案，然而明显跑不起来
// var ex3 = _.compose(chain(_.compose(getComments, _.prop('id'))), getPost)
//   log('ex3',ex3('hello').fork((error) => {
//     log(error)
//   }, (res) => {
//     log(res)
//   }))
...
//   var ex4 = _.compose(chain(emailBlast), addToMailingList, validateEmail);
var ex4 = _.compose(_.map(_.compose(chain(emailBlast), addToMailingList)), validateEmail);
  log(ex4('dddd@ddd.com'))
